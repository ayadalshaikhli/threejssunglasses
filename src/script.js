...
// const anim = gsap.to("#canvas-container", {
//     y: 100,
//     z:15,
//     rotation: 360,
//     duration: 3
...
/////////////////////////////////////////////////////////////////////////
///// SCENE LIGHTS
const sunLight = new DirectionalLight(0x452c72, 0.08)
sunLight.position.set(-100,0,-100)
scene.add(sunLight)

const fillLight = new PointLight(0x88dabb, 2.7, 4, 3)
fillLight.position.set(30,3,1.8)
scene.add(fillLight)

/////////////////////////////////////////////////////////////////////////
///// LOADING GLB/GLTF MODEL FROM BLENDER
loader.load('models/gltf/Glasses_Morpher.glb', function (gltf) {
    ...
    model.scale.set(15.1,15.1,15.1)
    scene.add(model)
    clearScene()
})
...
const mark = document.querySelector('.firstt')
const mark1 = document.querySelector('.secoundd')
const mark2 = document.querySelector('.thirdd')
